...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                ...
                break;
            case ID_POINT:
                shapeEditor.StartPointEditor();
                break;
            case ID_LINE:
                shapeEditor.StartLineEditor();
                break;
            case ID_RECT:
                shapeEditor.StartRectEditor();
                break;
            case ID_ELLIPSE:
                shapeEditor.StartEllipseEditor();
            break; 
            default:
    ...
    case WM_INITMENUPOPUP:
        shapeEditor.OnInitMenuPopup(hWnd, wParam);
        return 0;
    case WM_PAINT: 
        {
        ...
        break;
    case WM_LBUTTONDOWN:
        shapeEditor.OnLBdown(hWnd);
        break;
    case WM_LBUTTONUP:
        shapeEditor.OnLBup(hWnd);
        break;
    case WM_MOUSEMOVE:
        shapeEditor.OnMouseMove(hWnd);
        break;
    case WM_DESTROY:
        PostQuitMessage(0);
        break;
